...
def showVideo():
    ...
    for i in category_list:
        ...
        dummyCount = lambda x : 4 - (x % 4) if x % 4 != 0 else 0 # 비디오 개수 중 4의 배수가 아닌 수에 대한 dummy값 확인
        card_count[i] = {'collectionCount' : collectionCount, 'dummyCount' : dummyCount(videoCount), 'cardCount' : videoCount}
